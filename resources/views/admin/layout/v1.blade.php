...
<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    ...
    <script>
        $(function() {
            let msg_success = {!! json_encode(session('success')) !!};
            let msg_info = {!! json_encode(session('info')) !!};
            let msg_error = {!! json_encode(session('error')) !!};
            let msg_warning = {!! json_encode(session('warning')) !!};
